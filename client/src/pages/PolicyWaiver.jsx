    ...
    return (
        <div>
         ...
         <p className='text-justify mx-8'>
            ...
            <br />
            In a bid to be one of the richest and major knowledge repositories in the UAE, SJP receives submissions from a diverse network of knowledge enthusiasts, therefore, in case users believe that some papers are ineligible to be on the platform, they should immediately contact support (linked text or email) noting the title of the paper and candidly sharing their concerns thereof.
            </p>
