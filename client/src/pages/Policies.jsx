...
const Policies = () => {
  return (
    ...
    <div className="">
        ...
        <p>The Scientific Journals Portals’ published articles are subject to the Creative Commons Attribution 4.0 International License, which allows for the copying, redistribution, remixing, transmission, and adaptation of the work, provided that the original work and source are cited appropriately
</p>
    </div>
    <div className="">
        <h2>CrossRef Policy</h2>
        <p>Crossref [http://www.crossref.org/] is an organisation comprising publishers that has devised the Digital Object Identification (DOI) system for the distinctive identification of published materials. Scientific Journals Portal, as a member of Crossref, employs the DOI system to assign unique identifiers to all its published articles. http://crossref.org/crosscheck.html
</p>
    </div>
    <div className="">
        <h2>SimilarityCheck</h2>
        <p>The initiative known as SimilarityCheck [http://www.crossref.org/crosscheck/index.html], which is supported by Crossref, aims to facilitate the active participation of its members in combating scholarly and professional plagiarism. Scientific Journals Portal proudly stands as a member of SimilarityCheck.
</p>
    </div>
    <div className="">
