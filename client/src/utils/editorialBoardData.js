export const editorialBoardData = [
    ...
    },
    {
        ...
        profileImg:'https://i.postimg.cc/Gtfh8bX8/khulood.png'
    ...
    },
    {
        ...
        about:`Dr. Mohamed El Deeb is a member of the Editorial Board at the Scientific Journals Portal (SJP), where he oversees the editorial review of research on Engineering and Construction Management. Dr Deeb earned his PhD in Structural Engineering from Ain Shams University, which focused on an integrated approach for using BIM and LEAN thinking in construction management. Dr Deeb’s research interests span across Facilities Management, Facilities Planning, Housing, Built Environment, Property Management, Property Valuation, Urban Sustainability, and Desalination. Throughout his career, Dr Deeb has conducted extensive research on “Early Involvement of Facilities Management Towards Efficient Utilization” and “Adoption of Computer Aided Facilities Management (CAFM) to Improve Service Quality”. His research has been presented at popular international conferences such as the Proceedings of the Canadian Society for Civil Engineering Annual Conference and published on ResearchGate. Dr Deeb has also collaborated with other scientists on engineering projects to rethink novel ideas that aim to become tomorrow’s reality.`,
        contact_details:"drmohamed@scientificjournalsportal.com",
        profileImg:'https://i.postimg.cc/L4Qs0Vm9/deeb.png'
    ...
    },
    {
        ...
        profileImg:'https://i.postimg.cc/BQ8vW1vx/ngukaa.png'
    }
]